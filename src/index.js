...
import { faCheckSquare, faCoffee, faStar, faHeart, faSearch, faCogs, faRetweet, faCalendarAlt, faThumbsUp, faThumbsDown, faEye, faComment, faPlay, faHashtag, faTrash, faAd, faFrown} from '@fortawesome/free-solid-svg-icons'
library.add(fab, faCheckSquare, faStar, faHeart, faSearch, faCogs, faRetweet, faCalendarAlt, faThumbsUp, faThumbsDown, faEye, faComment, faPlay, faHashtag, faTrash, faAd, faFrown)
    ...
    render() {
        if (this.state.adminId==0 && this.state.userId==0) {
          ...
          return (
              <Router>
                <Switch>
                    <Route exact path='/admin' className="adminRoute" render={(props) => <AdminPageNew {...props} updateAdminId={this.updateAdminId} adminId={this.state.adminId}  updateUserId={this.updateUserId} userId={this.state.userId} />} />
                    <Route exact path='/adminold' className="adminRoute" render={(props) => <AdminPage {...props} updateAdminId={this.updateAdminId} adminId={this.state.adminId}  updateUserId={this.updateUserId} userId={this.state.userId} />} />
                    <Route exact path='/' className="adminRoute" render={(props) => <AdminPageNew {...props} updateAdminId={this.updateAdminId} adminId={this.state.adminId} updateUserId={this.updateUserId} userId={this.state.userId} />} />
                    <Route exact path='/register' render={(props) => <Register {...props} updateUserId={this.updateUserId} userId={this.state.userId} />} />
            ...
            return (
              <Router>
                  <Switch>
                      <Route exact path='/' render={(props) => <Popular {...props} updateUserId={this.updateUserId} userId={this.state.userId} adminId={this.state.adminId}/>} />
