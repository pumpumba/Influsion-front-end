      ...
      return (
        ...
        >
          ...
          <div className='expanded-view'>
            <div className='header'>
              <img src={this.props.data.platformcontent.user_profile_image_url} />
              <a href={this.props.data.platformcontent.user_screen_name.toLowerCase()}> <h3>{this.props.data.platformcontent.user_name} </h3></a>
              {this.props.data.platformcontent.user_verified && <img className="verifiedIcon" src={require('../../../img/Twitter_Verified_Badge.svg')} />}
              <StopPropagation>
                <a target_="blank" href={this.props.data.platformcontent.tweet_url}><FontAwesomeIcon className='icon' icon={['fab', 'twitter']} /></a>
              </StopPropagation>
            </div>
